let handler = async (m, { conn, usedPrefix, command }) => {
  try {
    ...
    if (!(m.text === ".freya" || m.selectedButtonId === "")) return;

    const urlJSON = "https://raw.githubusercontent.com/ILHAMGanzz26/dbbot/refs/heads/main/JKT48/FREYA/freya.json";
